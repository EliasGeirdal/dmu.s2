...
public class DecisionTreeDemo {
	public static void main(String[] args) {
		...
		BinaryTree<String> canivore = new BinaryTree<String>("Is it a carnivore?", tiger, zebra);

		BinaryTree<String> pig = new BinaryTree<String>("It is a pig.");
		BinaryTree<String> stripes = new BinaryTree<String>("Does it have stripes?", canivore, pig);
		...
		BinaryTree<String> swim = new BinaryTree<String>("Does it swim?", penguin, ostrich);
		...
		BinaryTree<String> questionTree = new BinaryTree<String>("Is it a mammal?", stripes, fly);
